                            ...
                            <div class="row justify-content-end ">
                                <div class="col-lg-6">
                                    ...
                                    <p>Outlines keep you and honest
                                        indulging honest.</p>
                                    <a href="index.html#">Read More <i class="fas fa-arrow-right"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white_card_body ">
                            <div class="single_user_pil d-flex align-items-center justify-content-between">
                                ...
                                <div class="action_btns d-flex">
                                    <a href="index.html#" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                    <a href="index.html#" class="action_btn"> <i class="fas fa-trash"></i> </a>
                                </div>
                            </div>
                                ...
                                <div class="header_more_tool">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                          <a class="dropdown-item" href="index.html#"> <i class="ti-eye"></i> Action</a>
                                          <a class="dropdown-item" href="index.html#"> <i class="ti-trash"></i> Delete</a>
                                          <a class="dropdown-item" href="index.html#"> <i class="fas fa-edit"></i> Edit</a>
                                          <a class="dropdown-item" href="index.html#"> <i class="ti-printer"></i> Print</a>
                                          <a class="dropdown-item" href="index.html#"> <i class="fa fa-download"></i> Download</a>
                                        </div>
                                      </div>
                                </div>
                            </div>
                                ...
                                <table class="table lms_table_active2 p-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="f_s_12 f_w_400 text-right"><a href="index.html#" class="text_color_1">Google</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                            ...
                                            <td class="f_s_12 f_w_400 color_text_7">#DE2548</td>
                                            <td class="f_s_12 f_w_400 color_text_6">60</td>
                                            <td class="f_s_12 f_w_400 text-right"><a href="index.html#" class="text_color_2">Direct</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="f_s_12 f_w_400 color_text_7">#DE2548</td>
                                            <td class="f_s_12 f_w_400 color_text_6">60</td>
                                            <td class="f_s_12 f_w_400 text-right"><a href="index.html#" class="text_color_1">Refferal</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                            ...
                                            <td class="f_s_12 f_w_400 color_text_7">#DE2548</td>
                                            <td class="f_s_12 f_w_400 color_text_6">60</td>
                                            <td class="f_s_12 f_w_400 text-right"><a href="index.html#" class="text_color_1">20</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                            ...
                                            <td class="f_s_12 f_w_400 color_text_7">#DE2548</td>
                                            <td class="f_s_12 f_w_400 color_text_6">60</td>
                                            <td class="f_s_12 f_w_400 text-right"><a href="index.html#" class="text_color_5">Direct</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                ...
                                <table class="table lms_table_active2 p-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="f_s_12 f_w_400 text-center"><a href="index.html#" class="text_color_1">20</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="f_s_12 f_w_400 color_text_6">$564</td>
                                            <td class="f_s_12 f_w_400 color_text_6">$650</td>
                                            <td class="f_s_12 f_w_400 text-center"><a href="index.html#" class="color_text_6">210</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                            ...
                                            <td class="f_s_12 f_w_400 color_text_6">$564</td>
                                            <td class="f_s_12 f_w_400 color_text_6">$650</td>
                                            <td class="f_s_12 f_w_400 text-center"><a href="index.html#" class="text_color_1">210</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                            ...
                                            <td class="f_s_12 f_w_400 color_text_6">$564</td>
                                            <td class="f_s_12 f_w_400 color_text_6">$650</td>
                                            <td class="f_s_12 f_w_400 text-center"><a href="index.html#" class="text_color_5">200</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="create_report_btn mt_30">
                                                <a href="index.html#" class="btn_1 radius_btn d-block text-center">Send the invitation link</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer_iner text-center">
                    <p>2020 © Influence - Designed by <a href="index.html#"> <i class="ti-heart"></i> </a><a href="index.html#"> DashboardPack</a></p>
                </div>
            </div>
        </div>
    </div>
